...
namespace ReSharperPlugin.SharpCoachPlugin
{
  ...
  {
    private static readonly ILogger ourLog = Logger.GetLogger("ReSharperPlugin.SharpCoachPlugin.Resources");
      ...
      CultureContextComponent.Instance.Change.Advise(Lifetime.Eternal, args =>
      {
          ...
          if (instance != null)
          {
            ourResourceManager = new Lazy<JetResourceManager>(
              ...
              {
                return instance
                  .CreateResourceManager("ReSharperPlugin.SharpCoachPlugin.Resources", typeof(Resources).Assembly);
              });
          }
          else
          {
